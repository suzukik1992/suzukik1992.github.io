    ...
    render() {
        ...
        return(
            <div style={workMainDivStyle}>
                ...
                <p style={{...workIntroductionStyle, fontSize:introFontSize, paddingBottom:introPaddingBottom}}>Developed 24.1ch surrund system and interactive system using MaxMsp.</p>
